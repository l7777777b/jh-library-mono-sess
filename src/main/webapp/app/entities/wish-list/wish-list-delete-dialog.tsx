...
export const WishListDeleteDialog = (props: IWishListDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.wishList.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.wishList.delete.question" interpolate={{ id: wishListEntity.id }}>

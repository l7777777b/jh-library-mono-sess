  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhlibrarymonosessApp.address.home.createOrEditLabel">
            <Translate contentKey="jhlibrarymonosessApp.address.home.createOrEditLabel">Create or edit a Address</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : addressEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="address-customer" type="select" className="form-control" name="customerId">
                  <option value="" key="0" />
                  {customers

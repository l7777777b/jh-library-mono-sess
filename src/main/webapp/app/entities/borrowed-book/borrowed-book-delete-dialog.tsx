...
export const BorrowedBookDeleteDialog = (props: IBorrowedBookDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.borrowedBook.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.borrowedBook.delete.question" interpolate={{ id: borrowedBookEntity.id }}>

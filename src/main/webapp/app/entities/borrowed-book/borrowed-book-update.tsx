  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhlibrarymonosessApp.borrowedBook.home.createOrEditLabel">
            <Translate contentKey="jhlibrarymonosessApp.borrowedBook.home.createOrEditLabel">Create or edit a BorrowedBook</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : borrowedBookEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="borrowed-book-book" type="select" className="form-control" name="bookId">
                  <option value="" key="0" />
                  {books
              ...
              <AvGroup>
                ...
                <AvInput id="borrowed-book-client" type="select" className="form-control" name="clientId">
                  <option value="" key="0" />
                  {clients

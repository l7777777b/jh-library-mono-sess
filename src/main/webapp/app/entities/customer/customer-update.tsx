  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhlibrarymonosessApp.customer.home.createOrEditLabel">
            <Translate contentKey="jhlibrarymonosessApp.customer.home.createOrEditLabel">Create or edit a Customer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : customerEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="firstNameLabel" for="customer-firstName">
                  <Translate contentKey="jhlibrarymonosessApp.customer.firstName">First Name</Translate>
                </Label>
                <AvField id="customer-firstName" type="text" name="firstName" />
              </AvGroup>
              <AvGroup>
                <Label id="lastNameLabel" for="customer-lastName">
                  <Translate contentKey="jhlibrarymonosessApp.customer.lastName">Last Name</Translate>
                </Label>
                <AvField id="customer-lastName" type="text" name="lastName" />
              </AvGroup>
              <AvGroup>
                <Label id="emailLabel" for="customer-email">
                  <Translate contentKey="jhlibrarymonosessApp.customer.email">Email</Translate>
                </Label>
                <AvField id="customer-email" type="text" name="email" />
              </AvGroup>
              <AvGroup>
                <Label id="telephoneLabel" for="customer-telephone">
                  <Translate contentKey="jhlibrarymonosessApp.customer.telephone">Telephone</Translate>
                </Label>

...
export const CustomerDeleteDialog = (props: ICustomerDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.customer.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>

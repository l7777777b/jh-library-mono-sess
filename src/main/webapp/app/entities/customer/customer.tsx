  ...
  return (
    <div>
      <h2 id="customer-heading">
        <Translate contentKey="jhlibrarymonosessApp.customer.home.title">Customers</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhlibrarymonosessApp.customer.home.createLabel">Create new Customer</Translate>
        </Link>
      </h2>
        ...
        {customerList && customerList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('firstName')}>
                  <Translate contentKey="jhlibrarymonosessApp.customer.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('lastName')}>
                  <Translate contentKey="jhlibrarymonosessApp.customer.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="jhlibrarymonosessApp.customer.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('telephone')}>
                  <Translate contentKey="jhlibrarymonosessApp.customer.telephone">Telephone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhlibrarymonosessApp.customer.home.notFound">No Customers found</Translate>
            </div>
          )
        )}
      </div>

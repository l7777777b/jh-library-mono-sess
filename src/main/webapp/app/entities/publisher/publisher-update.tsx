  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhlibrarymonosessApp.publisher.home.createOrEditLabel">
            <Translate contentKey="jhlibrarymonosessApp.publisher.home.createOrEditLabel">Create or edit a Publisher</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">

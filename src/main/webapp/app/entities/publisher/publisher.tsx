  ...
  return (
    <div>
      <h2 id="publisher-heading">
        <Translate contentKey="jhlibrarymonosessApp.publisher.home.title">Publishers</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhlibrarymonosessApp.publisher.home.createLabel">Create new Publisher</Translate>
        </Link>
      </h2>
        ...
        {publisherList && publisherList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="jhlibrarymonosessApp.publisher.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhlibrarymonosessApp.publisher.home.notFound">No Publishers found</Translate>
            </div>
          )
        )}
      </div>

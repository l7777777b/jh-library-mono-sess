...
export const PublisherDeleteDialog = (props: IPublisherDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.publisher.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.publisher.delete.question" interpolate={{ id: publisherEntity.id }}>

...
export const CategoryDeleteDialog = (props: ICategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.category.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>

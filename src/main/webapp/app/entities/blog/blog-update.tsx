  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhlibrarymonosessApp.blog.home.createOrEditLabel">
            <Translate contentKey="jhlibrarymonosessApp.blog.home.createOrEditLabel">Create or edit a Blog</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : blogEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="blog-name">
                  <Translate contentKey="jhlibrarymonosessApp.blog.name">Name</Translate>
                </Label>
                <AvField
                  id="blog-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="handleLabel" for="blog-handle">
                  <Translate contentKey="jhlibrarymonosessApp.blog.handle">Handle</Translate>
                </Label>
                <AvField
                  id="blog-handle"
                  type="text"
              ...
              <AvGroup>
                <Label for="blog-user">
                  <Translate contentKey="jhlibrarymonosessApp.blog.user">User</Translate>
                </Label>

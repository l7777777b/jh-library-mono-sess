  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhlibrarymonosessApp.client.home.createOrEditLabel">
            <Translate contentKey="jhlibrarymonosessApp.client.home.createOrEditLabel">Create or edit a Client</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : clientEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="firstNameLabel" for="client-firstName">
                  <Translate contentKey="jhlibrarymonosessApp.client.firstName">First Name</Translate>
                </Label>
                <AvField
                  id="client-firstName"
                  type="text"
              ...
              <AvGroup>
                <Label id="lastNameLabel" for="client-lastName">
                  <Translate contentKey="jhlibrarymonosessApp.client.lastName">Last Name</Translate>
                </Label>
                <AvField
                  id="client-lastName"
                  type="text"
              ...
              <AvGroup>
                <Label id="emailLabel" for="client-email">
                  <Translate contentKey="jhlibrarymonosessApp.client.email">Email</Translate>
                </Label>
                <AvField
                  id="client-email"
                  type="text"
              ...
              <AvGroup>
                <Label id="addressLabel" for="client-address">
                  <Translate contentKey="jhlibrarymonosessApp.client.address">Address</Translate>
                </Label>
                <AvField
                  id="client-address"
                  type="text"
              ...
              <AvGroup>
                <Label id="phoneLabel" for="client-phone">
                  <Translate contentKey="jhlibrarymonosessApp.client.phone">Phone</Translate>
                </Label>
                <AvField
                  id="client-phone"
                  type="text"

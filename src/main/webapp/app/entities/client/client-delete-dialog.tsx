...
export const ClientDeleteDialog = (props: IClientDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.client.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.client.delete.question" interpolate={{ id: clientEntity.id }}>

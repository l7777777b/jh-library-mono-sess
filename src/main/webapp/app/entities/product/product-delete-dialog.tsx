...
export const ProductDeleteDialog = (props: IProductDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.product.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.product.delete.question" interpolate={{ id: productEntity.id }}>

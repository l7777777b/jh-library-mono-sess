...
export const AuthorDeleteDialog = (props: IAuthorDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhlibrarymonosessApp.author.delete.question">
        <Translate contentKey="jhlibrarymonosessApp.author.delete.question" interpolate={{ id: authorEntity.id }}>

  ...
  return (
    <div>
      <h2 id="author-heading">
        <Translate contentKey="jhlibrarymonosessApp.author.home.title">Authors</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhlibrarymonosessApp.author.home.createLabel">Create new Author</Translate>
        </Link>
      </h2>
        ...
        {authorList && authorList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('firstName')}>
                  <Translate contentKey="jhlibrarymonosessApp.author.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('lastName')}>
                  <Translate contentKey="jhlibrarymonosessApp.author.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhlibrarymonosessApp.author.home.notFound">No Authors found</Translate>
            </div>
          )
        )}
      </div>

...
import com.jhtest.app.JhlibrarymonosessApp;
 ...
 */
@SpringBootTest(classes = JhlibrarymonosessApp.class)
...
public class BorrowedBookResourceIT {
    ...
    public void createBorrowedBook() throws Exception {
        ...
        restBorrowedBookMockMvc.perform(post("/api/borrowed-books").with(csrf())
    ...
    public void updateBorrowedBook() throws Exception {
        ...
        restBorrowedBookMockMvc.perform(put("/api/borrowed-books").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
            .content(TestUtil.convertObjectToJsonBytes(borrowedBookDTO)))
            .andExpect(status().isOk());
    ...
    public void deleteBorrowedBook() throws Exception {
        ...
        restBorrowedBookMockMvc.perform(delete("/api/borrowed-books/{id}", borrowedBook.getId()).with(csrf())
